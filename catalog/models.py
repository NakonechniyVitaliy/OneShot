...
class Product(models.Model):
    ...
    color = models.TextField(max_length=500, default="None")
    size = models.TextField(max_length=500, default='None')
    ...
    sort_by = models.CharField(max_length=100, default='None')
